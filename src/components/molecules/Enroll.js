    ...
    <div className="pad padd enbg">
      ...
      <div className="d-flex flex-column flex-lg-row gap-4 py-3">
        <Enrollpill
          ...
          src={picc1}
          className="w-100 rounded-4 text-white stepone d-flex"
        />
        <Enrollpill
          h3="Step Two"
          h5="Enrollment Guide"
          ...
          src={picc2}
          className="w-100 rounded-4 text-white steptwo d-flex swap"
        />
      </div>
      <div className="d-flex flex-column flex-lg-row gap-4 py-3">
        <Enrollpill
          ...
          src={picc3}
          className="w-100 rounded-4 text-white steptwo d-flex"
        />
        <Enrollpill
          h3="Step Four"
          h5="You Are All Set!" 
          ...
          src={picc4}
          className="w-100 rounded-4 text-white stepone swap d-flex"
        />
      </div>
    </div>
  );
